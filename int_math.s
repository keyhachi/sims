...
;lib_sinint.ml@1:28;1:31
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1654
@emit_label_1653:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1653
@emit_label_1654:
	mov r5,r7
	sw r5,r31,$608
...
;lib_sinint.ml@2:28;2:31
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1656
@emit_label_1655:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1655
@emit_label_1656:
	mov r5,r7
	sw r5,r31,$596
...
;lib_sinint.ml@53:0;53:40::=OArrWritelib_sinint.ml@2:12;2:31lib_sinint.ml@53:7;53:9lib_sinint.ml@53:14;53:40
	li r5,$65
	sw r5,r31,$16
;./test/int_math_operation.ml@1:12;1:20
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$16
;./test/int_math_operation.ml@1:12;1:20::<=./test/int_math_operation.ml@1:12;1:20
	jal print_char
	sw r5,r31,$12
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;./test/int_math_operation.ml@1:0;1:21./test/int_math_operation.ml@1:0;1:10
	li r5,$65
	sw r5,r31,$8
;./test/int_math_operation.ml@2:12;2:20
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$8
;./test/int_math_operation.ml@2:12;2:20::<=./test/int_math_operation.ml@2:12;2:20
	jal print_char
	sw r5,r31,$4
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;./test/int_math_operation.ml@2:0;2:21./test/int_math_operation.ml@1:0;1:10
	li r5,$65
	sw r5,r31,$0
;./test/int_math_operation.ml@3:12;3:20
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$0
;./test/int_math_operation.ml@3:12;3:20::<=./test/int_math_operation.ml@3:12;3:20
	jal print_char
	mov r8,r5
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;@0:-1;0:-1./test/int_math_operation.ml@1:0;1:10
	hlt 
