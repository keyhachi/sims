...
;lib_sinint.ml@1:28;1:31
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1922
@emit_label_1921:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1921
@emit_label_1922:
	mov r5,r7
	sw r5,r31,$616
...
;lib_sinint.ml@2:28;2:31
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1924
@emit_label_1923:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1923
@emit_label_1924:
	mov r5,r7
	sw r5,r31,$604
...
;lib_sinint.ml@53:0;53:40::=OArrWritelib_sinint.ml@2:12;2:31lib_sinint.ml@53:7;53:9lib_sinint.ml@53:14;53:40
	li r5,$24
	sw r5,r31,$24
;./test/make_dest_tuple.ml@6:13;6:16
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$24
;./test/make_dest_tuple.ml@6:13;6:16::<=./test/make_dest_tuple.ml@6:13;6:16
	jal @a_877print_int
	sw r5,r31,$20
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;./test/make_dest_tuple.ml@6:2;6:17./test/make_dest_tuple.ml@6:2;6:11
	li r5,$10
	sw r5,r31,$16
;./test/make_dest_tuple.ml@7:13;7:15
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$16
;./test/make_dest_tuple.ml@7:13;7:15::<=./test/make_dest_tuple.ml@7:13;7:15
	jal print_char
	sw r5,r31,$12
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;./test/make_dest_tuple.ml@17:1;17:9./test/make_dest_tuple.ml@7:2;7:12
	li r5,$30
	sw r5,r31,$8
;./test/make_dest_tuple.ml@13:16;13:18
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$8
;./test/make_dest_tuple.ml@13:16;13:18::<=./test/make_dest_tuple.ml@13:16;13:18
	jal @a_877print_int
	sw r5,r31,$4
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;./test/make_dest_tuple.ml@14:2;14:13./test/make_dest_tuple.ml@6:2;6:11
	li r5,$10
	sw r5,r31,$0
;./test/make_dest_tuple.ml@15:13;15:15
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$0
;./test/make_dest_tuple.ml@15:13;15:15::<=./test/make_dest_tuple.ml@15:13;15:15
	jal print_char
	mov r8,r5
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;@0:-1;0:-1./test/make_dest_tuple.ml@7:2;7:12
	hlt 
