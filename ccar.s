...
;lib_sinint.ml@111:5;111:11::=Oimul[10]lib_sinint.ml@110:10;110:19
	slt r5,r12,r15
	bne r0,r5,@cfg_label_1852
	j @cfg_label_1851
	j @cfg_label_1853
@cfg_label_1852:
	slt r5,r14,r13
	bne r0,r5,@cfg_label_1848
	j @cfg_label_1847
	j @cfg_label_1849
	j @cfg_label_1850
@cfg_label_1849:
...
;lib_sinint.ml@1:28;1:31
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1868
@emit_label_1867:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1867
@emit_label_1868:
	mov r5,r7
	sw r5,r31,$620
...
;lib_sinint.ml@2:28;2:31
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1870
@emit_label_1869:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1869
@emit_label_1870:
	mov r5,r7
	sw r5,r31,$608
...
;lib_sinint.ml@53:0;53:40::=OArrWritelib_sinint.ml@2:12;2:31lib_sinint.ml@53:7;53:9lib_sinint.ml@53:14;53:40
	li r5,$10
	sw r5,r31,$28
;./test/check_const_arr_rw.ml@2:22;2:24
	li r5,$0
	sw r5,r31,$24
;./test/check_const_arr_rw.ml@2:25;2:26
	lw r5,r31,$28
	lw r6,r31,$24
	mov r7,r3
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1872
@emit_label_1871:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1871
@emit_label_1872:
	mov r5,r7
	sw r5,r31,$20
;./test/check_const_arr_rw.ml@2:9;2:26::=OArrCrt./test/check_const_arr_rw.ml@2:22;2:24./test/check_const_arr_rw.ml@2:25;2:26
	li r5,$6
	sw r5,r31,$16
;./test/check_const_arr_rw.ml@7:14;7:15
	lw r5,r31,$20
	lw r6,r31,$16
	sw r6,r5,$4
	sw r5,r31,$12
;./test/check_const_arr_rw.ml@4:2;4:12::=OiArrWrite[1]./test/check_const_arr_rw.ml@2:9;2:26./test/check_const_arr_rw.ml@7:14;7:15
	lw r5,r31,$20
	lw r5,r5,$4
	sw r5,r31,$8
;./test/check_const_arr_rw.ml@7:12;7:15::=OiArrRead[1]./test/check_const_arr_rw.ml@2:9;2:26
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$8
;./test/check_const_arr_rw.ml@7:12;7:15::<=./test/check_const_arr_rw.ml@7:12;7:15
	jal @a_854print_int
	sw r5,r31,$4
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;./test/check_const_arr_rw.ml@7:1;7:16./test/check_const_arr_rw.ml@7:1;7:10
	li r5,$10
	sw r5,r31,$0
;./test/check_const_arr_rw.ml@8:12;8:14
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$0
;./test/check_const_arr_rw.ml@8:12;8:14::<=./test/check_const_arr_rw.ml@8:12;8:14
	jal print_char
	mov r8,r5
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;@0:-1;0:-1./test/check_const_arr_rw.ml@8:1;8:11
	hlt 
