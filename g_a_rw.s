...
;lib_sinint.ml@1:28;1:31
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1894
@emit_label_1893:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1893
@emit_label_1894:
	mov r5,r7
	sw r5,r31,$636
...
;lib_sinint.ml@2:28;2:31
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1896
@emit_label_1895:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1895
@emit_label_1896:
	mov r5,r7
	sw r5,r31,$624
...
;lib_sinint.ml@53:0;53:40::=OArrWritelib_sinint.ml@2:12;2:31lib_sinint.ml@53:7;53:9lib_sinint.ml@53:14;53:40
	li r5,$2
	sw r5,r31,$44
;./test/global_array_rw.ml@1:22;1:23
	li r5,$6
	sw r5,r31,$40
;./test/global_array_rw.ml@1:24;1:25
	lw r5,r31,$44
	lw r6,r31,$40
	mov r7,r3
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1898
@emit_label_1897:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1897
@emit_label_1898:
	mov r5,r7
	sw r5,r31,$36
;./test/global_array_rw.ml@1:9;1:25::=OArrCrt./test/global_array_rw.ml@1:22;1:23./test/global_array_rw.ml@1:24;1:25
	lw r5,r31,$36
	lw r5,r5,$4
	sw r5,r31,$32
;./test/global_array_rw.ml@6:11;6:16::=OiArrRead[1]./test/global_array_rw.ml@1:9;1:25
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$32
;./test/global_array_rw.ml@6:11;6:16::<=./test/global_array_rw.ml@6:11;6:16
	jal @a_874print_int
	sw r5,r31,$28
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;./test/global_array_rw.ml@6:0;6:17./test/global_array_rw.ml@6:0;6:9
	li r5,$1
	sw r5,r31,$24
;./test/global_array_rw.ml@7:4;7:5
	li r5,$7
	sw r5,r31,$20
;./test/global_array_rw.ml@7:6;7:7
	lw r5,r31,$36
	lw r6,r31,$24
	lw r7,r31,$20
	sll r6,r6,$2
	...
	sw r7,r5,$0
	sw r5,r31,$16
;./test/global_array_rw.ml@7:0;7:7::=OArrWrite./test/global_array_rw.ml@1:9;1:25./test/global_array_rw.ml@7:4;7:5./test/global_array_rw.ml@7:6;7:7
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$32
;./test/global_array_rw.ml@6:11;6:16::<=./test/global_array_rw.ml@6:11;6:16
	...
	lw r4,r1,$0
	addi r1,r1,$4
;./test/global_array_rw.ml@8:0;8:17./test/global_array_rw.ml@6:0;6:9
	lw r5,r31,$36
	lw r5,r5,$0
	sw r5,r31,$8
;./test/global_array_rw.ml@9:11;9:16::=OiArrRead[0]./test/global_array_rw.ml@1:9;1:25
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$8
;./test/global_array_rw.ml@9:11;9:16::<=./test/global_array_rw.ml@9:11;9:16
	jal @a_874print_int
	sw r5,r31,$4
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;./test/global_array_rw.ml@9:0;9:17./test/global_array_rw.ml@6:0;6:9
	li r5,$10
	sw r5,r31,$0
;./test/global_array_rw.ml@10:11;10:13
	subi r1,r1,$4
	sw r4,r1,$0
	subi r1,r1,$4
	lw r10,r31,$0
;./test/global_array_rw.ml@10:11;10:13::<=./test/global_array_rw.ml@10:11;10:13
	jal print_char
	mov r8,r5
	addi r1,r1,$4
	lw r4,r1,$0
	addi r1,r1,$4
;@0:-1;0:-1./test/global_array_rw.ml@10:0;10:10
	hlt 
