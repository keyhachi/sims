...
@cfg_label_1602:
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1659
@emit_label_1658:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1658
@emit_label_1659:
	mov r5,r7
	sw r5,r31,$760
...
@cfg_label_1599:
	...
	sll r5,r5,$2
	add r5,r3,r5
	beq r3,r5,@emit_label_1661
@emit_label_1660:
	sw r6,r3,$0
	addi r3,r3,$4
	bne r3,r5,@emit_label_1660
@emit_label_1661:
	mov r5,r7
	sw r5,r31,$748
